...
public class HomePageController {
	...
	public void signup(@RequestParam(value = "name") String name, @RequestParam(value = "uname") String uname,
			@RequestParam(value = "pwd") String pwd, @RequestParam(value = "email") String email,
			@RequestParam(value = "mobile_number") String mobile_number, @RequestParam(value = "role") String role,
			@RequestParam(value = "dob") String dob

	) {
		usrSrvc.save(new User(name, uname, pwd, email, mobile_number, role, dob));
	}
	...
	public String test(Model model) {
		...
		// .getDrugInteraction(Arrays.asList("methadone", "Venlafaxine",
		// "cisplatin", "ibuprofen"));
		System.out.println(names.getData());
		// System.out.println(drugInteraction);
		System.out.println(drugsAPI.getListOfDrugsFoundInText(
		...
		// User user=new
		// User("Siddharth","sid","securedPassword#123","jas@jdkd.com","8123277163","patient","09-08-1997");
		// usrSrvc.save(user);
	...
	public DrugInteraction getDrugInteraction(HttpSession session,
			@RequestParam(value = "primary") String primaryDrugName) {
